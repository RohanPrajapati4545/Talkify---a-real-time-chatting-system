 ...
 <button
        ...
        <div className="row g-3">
          <div className="col-12 col-md-4">
            <div className="rounded-3 p-3 h-100" style={{ border: "1px solid #1a2430", background: "#121820" }}>
            ...
            <div className="rounded-3 p-3 h-100" style={{ border: "1px solid #1a2430", background: "#121820" }}>
              ...
              <div className="d-flex align-items-center gap-3">
                <div
                  ...
                  style={{ width: 64, height: 64, overflow: "hidden", background: "#080b0e", borderColor: "#1a2430" }}
                >
                  {currentLogoSrc ? (
                    <img
                      src={currentLogoSrc}
                    ...
                    <i className="fa-solid fa-feather-pointed text-emerald" style={{ fontSize: "1.5rem" }}></i>
                  )}
                </div>
                ...
                <div className="flex-grow-1">
                  ...
                  {logoFile && (
                    <button
                      type="button"
                      className="btn btn-link btn-sm p-0 mt-1 text-emerald"
              ...
              <div className="d-flex align-items-center gap-3">
                ...
                >
                  {currentFaviconSrc ? (
                    ...
                    <i className="fa-solid fa-star text-cyan" style={{ fontSize: "1.5rem" }}></i>
                  )}
                </div>
                ...
                <div className="flex-grow-1">
                  ...
                  {faviconFile && (
                    <button
                      type="button"
                      className="btn btn-link btn-sm p-0 mt-1 text-cyan"
      ...
      <div className="bg-white rounded-4 shadow-sm p-4 mb-3">
        ...
        <div className="rounded-3 p-3 d-flex justify-content-between align-items-center" style={{ border: "1px solid #1a2430", background: "#121820" }}>
          <div>
