...
const AllGroups = () => {
  ...
  const openEditGroup = (group) => {
    ...
    setEditGroupImagePreview(group.groupImage || "");
  };
  ...
  const handleEditGroupImageChange = (e) => {
  ...
  const handleEditGroupSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("groupDescription", editGroupDescription);
      if (editGroupImage) formData.append("groupImage", editGroupImage);
