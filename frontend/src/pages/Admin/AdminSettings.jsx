        ...
        <div className="d-flex flex-column gap-2">
          {settingsPages.map(({ title, description, icon: Icon, path }) => (
            <button
              ...
              className="btn d-flex align-items-center justify-content-between text-start p-3 rounded-3"
              style={{
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.background = "#16202c";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = "#1a2430";
            ...
            >
              <div className="d-flex align-items-center gap-3">
                ...
                <div>
                  <div className="fw-semibold" style={{ fontSize: "14px", color: "#f8fafc" }}>
                    {title}
                  </div>
